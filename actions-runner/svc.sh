...
SVC_NAME="actions.runner.DSE-8-oauth2-springboot-angular-googlesignin-poc.CD.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (DSE-8-oauth2-springboot-angular-googlesignin-poc.CD)"
